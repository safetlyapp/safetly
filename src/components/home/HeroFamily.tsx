...
export default function HeroFamily({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 220 260" className={className} aria-hidden="true">
      ...
      {/* dad hair */}
      <path
        d="M65 80c0-22 18-38 30-38s30 16 30 38c-8-6-14-10-30-10s-22 4-30 10Z"
        fill="#4b2e1e"
      />
      {/* dad face */}
      ...
      <g>
        ...
        <path
          d="M133 128c0-14 10-24 18-24s18 10 18 24c-6-4-11-6-18-6s-12 2-18 6Z"
          fill="#78350f"
        />
      ...
      <g>
        ...
        <path
          d="M12 96c0-12 8-20 17-20s17 8 17 20c-5-3-10-5-17-5s-12 2-17 5Z"
          fill="#4b2e1e"
        />
