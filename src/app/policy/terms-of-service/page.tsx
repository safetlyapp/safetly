    ...
    <div className="space-y-8 text-sm leading-relaxed text-slate-600">
      ...
      <div className="space-y-8">
        <Section num="1" title="Purpose of Safetly">
          ...
          <p>
            Not all features may be available on every device, operating system,
            app version, region, or subscription plan. Due to technical and
            platform limitations, Android and iPhone devices may not support the
            same features or may provide different levels of functionality.
          </p>
        </Section>
        ...
        <Section num="2" title="Who May Use Safetly">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              Authorized family devices under the parent&apos;s or
              guardian&apos;s lawful supervision
            </li>
          </ul>
          <p>
            A person must be at least 18 years old to create or manage a parent
            or guardian account.
          </p>
          <p>
        ...
        <Section num="3" title="Authorized Use">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              A device that you lawfully own, control, or have the legal
        ...
        <Section num="5" title="Device Connection and Required Permissions">
          ...
          <p>
            If you deny, disable, revoke, or restrict a required permission,
            certain features may function only partially or may stop working
            entirely.
          </p>
        </Section>
        ...
        <Section num="6" title="Location Services and Geofencing">
          <p>
            Live location, location history, and geofencing features may depend
            on GPS, mobile networks, Wi-Fi, internet connectivity, device
            settings, operating-system services, battery status, and other
            technical systems.
          </p>
          <p>
            Location information may be inaccurate, delayed, incomplete, or
            unavailable due to factors such as:
          </p>
          <ul className="list-disc space-y-1 pl-5">
          ...
          <p>
            Geofence alerts are intended as helpful tools only. They are not
            emergency services, guarantees of safety, or systems for detecting
            immediate danger.
          </p>
        </Section>
        ...
        <Section
          num="7"
          title="Screen Mirroring, Remote Camera, and Ambient Sound"
        >
          <p>
            Screen mirroring, remote camera, and ambient-sound features may
            involve sensitive information. These features may be used only on:
          </p>
          <ul className="list-disc space-y-1 pl-5">
            <li>Your child&apos;s device</li>
            <li>Your own device</li>
            <li>
              A family device that you are legally authorized to supervise
            </li>
          </ul>
          <p>
            You are responsible for complying with all applicable laws, platform
            requirements, permission requirements, notice obligations, and
        ...
        >
          ...
          <p>
            The availability and functionality of these features may vary based
            on:
          </p>
          <ul className="list-disc space-y-1 pl-5">
            <li>Device type</li>
          ...
          <p>
            Any information accessed through these features must be used only
            for lawful parental supervision, child protection, and family-safety
            purposes.
          </p>
          <p>
            You must not unlawfully collect, disclose, publish, sell, share, or
        ...
        <Section num="9" title="Content Filtering and App Blocking">
          ...
          <p>
            However, no filtering or blocking system is completely accurate or
            effective in every situation. For example:
          </p>
          <ul className="list-disc space-y-1 pl-5">
            <li>Harmful content may not always be detected or blocked</li>
            <li>Safe or appropriate content may be blocked by mistake</li>
            <li>
              New, unknown, encrypted, or technically altered content may bypass
              filters
            </li>
            <li>
              Third-party applications or platforms may change their behavior or
              technical systems
            </li>
          </ul>
          <p>
            Parents and guardians should regularly review their children&apos;s
        ...
        <Section num="10" title="Screen Time and App Usage Reports">
          ...
          <p>
            Such information may be delayed, incomplete, estimated, or
            inaccurate due to:
          </p>
          <ul className="list-disc space-y-1 pl-5">
        ...
        >
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              They have the legal authority to connect and supervise the
              child&apos;s device
            </li>
            <li>
              All notices, permissions, and consents required by applicable law
              have been provided or obtained
            </li>
            <li>
              Children&apos;s information is used only for lawful, appropriate,
              and safety-related purposes
            </li>
            <li>
              The child&apos;s privacy, dignity, and best interests are
              respected
            </li>
          </ul>
          <p>
        ...
        <Section num="13" title="Subscriptions and Premium Services">
          ...
          <p>
            The applicable price, duration, available features, device limits,
            and other relevant information will be displayed before payment is
            completed.
          </p>
          <p>
        ...
        <Section num="14" title="Payments and Renewals">
          ...
          <p>
            If automatic renewal is offered, the applicable renewal terms and
            any automatic charges will be disclosed before the user subscribes
        ...
        <Section num="15" title="Refunds">
          ...
          <p>
            ...
            approved. Each request may be reviewed based on payment records,
            service usage, the nature of the issue, applicable policies, and
            applicable law.
          </p>
          <p>
            Subscription cancellation and refunds are separate processes.
            Canceling a subscription does not automatically entitle a user to a
        ...
        <Section num="16" title="Prohibited Uses">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              Access another person&apos;s location, screen, camera, microphone,
              calls, SMS, or notifications without lawful authority and any
              required consent
            </li>
            <li>Harass, threaten, stalk, intimidate, or harm another person</li>
            <li>
              Collect, steal, disclose, publish, sell, or misuse personal
              information
            </li>
            <li>
              Violate privacy, data-protection, child-protection,
            ...
            <li>
              Make fraudulent payments, chargeback claims, or false refund
              requests
            </li>
            <li>
        ...
        <Section num="17" title="Account Suspension or Termination">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              Suspension is required by applicable law, a lawful authority, or a
              legal process
            </li>
            <li>
        ...
        <Section num="19" title="Service Availability and Limitations">
          ...
          <p>
            The Services may be temporarily unavailable because of maintenance,
            updates, security measures, technical problems, internet or network
            failures, server issues, operating-system changes, or third-party
            limitations.
          </p>
        </Section>
        ...
        <Section num="21" title="Limitation of Liability">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              Inaccurate, delayed, incomplete, or unavailable location
              information
            </li>
            <li>A feature not functioning as expected</li>
            <li>Failure to filter or block particular content</li>
            <li>
              Device, network, internet, operating-system, or software problems
            </li>
          ...
          <p>
            Nothing in these Terms limits or excludes any right or liability
        ...
        <Section num="22" title="User Responsibility">
          ...
          <p>
            You may be responsible, to the extent permitted by applicable law,
            for claims, losses, damages, or legal consequences resulting from
            your:
          </p>
          <ul className="list-disc space-y-1 pl-5">
          ...
          <p>
            ...
            monitoring, and surveillance laws that apply in your country or
            region.
          </p>
        </Section>
        ...
        <Section num="25" title="Governing Law and Dispute Resolution">
          <p>
            ...
            the applicable laws of Bangladesh, unless another mandatory law
            applies.
          </p>
          <p>
          ...
          <p>
            ...
            the appropriate court, authority, or legal process with jurisdiction
            under applicable law.
          </p>
          <p>
        ...
        <Section num="27" title="Acceptance of These Terms">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              You will comply with applicable laws relating to privacy,
              children&apos;s safety, data protection, communications,
