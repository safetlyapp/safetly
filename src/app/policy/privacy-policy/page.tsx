    ...
    <div className="space-y-8 text-sm leading-relaxed text-slate-600">
      ...
      <div className="space-y-8">
        <Section num="1" title="Purpose and Features of Seftly">
          ...
          <p>
            Not all features may be available on every Android or iPhone device.
            Feature availability and functionality may vary due to
        ...
        <Section num="2" title="Information We May Collect or Process">
          ...
          <SubSection title="2.2 Device and Technical Information">
            <p>
              ...
              language/region, permission status, performance and error
              information, and limited network information.
            </p>
          </SubSection>
          ...
          <SubSection title="2.3 Location Information">
            ...
            <p className="mt-2">
              Location information may depend on GPS, Wi-Fi, mobile networks,
              internet connectivity, and the device&apos;s location services,
              and may not always be accurate, current, continuous, or available.
            </p>
          </SubSection>
          ...
          <SubSection title="2.5 Website and Content-Related Information">
            ...
            <p className="mt-2">
              ...
              identified, categorized, blocked, or filtered accurately in every
              situation.
            </p>
          </SubSection>
          ...
          <SubSection title="2.6 Screen Mirroring, Remote Camera, and Ambient Sound">
            <p>
              ...
              family-safety purposes. Information transmitted through these
              features is transmitted in encrypted form through secure
              communication systems to help reduce the risk of unauthorized
              access while the information is being transmitted.
            </p>
            <p className="mt-2">
          ...
          <SubSection title="2.7 Call, SMS, and Notification-Related Information">
            ...
            <p className="mt-2">
              ...
              connection, technical limitations, and applicable platform
              policies.
            </p>
          </SubSection>
        </Section>
        ...
        <Section num="3" title="How We Use Information">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              Apply app-blocking, content-filtering, and other parental controls
            </li>
            ...
            <li>
              Improve the functionality, stability, security, and reliability of
              the application
            </li>
            <li>
              Prevent misuse, fraud, unauthorized access, or other harmful
              activity
            </li>
            <li>
              Comply with applicable laws, legal obligations, or valid legal
              requests
            </li>
          </ul>
        </Section>
        ...
        >
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              They have the legal authority to supervise the child&apos;s device
            </li>
            <li>
              Any required permission or consent has been obtained under
              applicable law
            </li>
            <li>
              Children&apos;s information is used only for lawful, safe, and
              appropriate purposes
            </li>
            <li>
              The child&apos;s privacy, dignity, rights, and best interests are
              considered
            </li>
          </ul>
          <p>
        ...
        <Section num="6" title="How We May Share Information">
          ...
          <p>
            ...
            our services or comply with legal requirements, including with:
          </p>
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              Government authorities, courts, or other parties when required by
              law, a court order, or a valid legal request
            </li>
            <li>
          ...
          <p>
            When information is shared, we may take appropriate steps to help
        ...
        <Section num="7" title="Payment-Related Information">
          ...
          <p>
            Payment-service providers may process payment-related information
            under their own privacy policies, security practices, and terms.
          </p>
        </Section>
        ...
        <Section num="8" title="Information Security">
          ...
          <p>
            Encryption technology is used during the transmission of information
            associated with screen mirroring, remote camera, ambient sound,
            call/SMS, and notification-related features to help reduce the risk
            of unauthorized access during transmission.
          </p>
          <p>
          ...
          <p>
            You are responsible for keeping your account password, OTP, and
        ...
        <Section num="9" title="Data Retention">
          ...
          <p>
            This information may be temporarily processed or transmitted in
            encrypted form only for the limited period necessary to operate the
            relevant feature or display it to an authorized parent account.
          </p>
          <p>
            Account information, subscription information, payment records,
            device-related information, location information, security logs, or
            information required by law may be retained for different periods
            depending on the nature of the information, service requirements,
        ...
        <Section num="10" title="Your Information Rights">
          ...
          <p>
            Some requests may not be fully fulfilled due to legal requirements,
            security concerns, technical limitations, or lawful record-retention
            obligations.
          </p>
        </Section>
        ...
        <Section num="11" title="Account Closure and Data Deletion">
          ...
          <p>
            After an account is closed, some information may not be deleted
            immediately. Certain information may be retained for a limited
            period when necessary for security, fraud prevention, dispute
            resolution, payment records, legal obligations, or other legitimate
            purposes.
          </p>
          <p>
        ...
        <Section num="12" title="Third-Party Services">
          ...
          <p>
            ...
            terms of service. We encourage users to review the privacy policies
            and terms of any third-party services they use.
          </p>
        </Section>
        ...
        <Section num="13" title="Third-Party Websites and Links">
          ...
          <p>
            You should review the applicable privacy policies and terms before
        ...
        <Section num="14" title="Changes to This Privacy Policy">
          ...
          <p>
            ...
            application, website, email, notification, or another appropriate
            method, where required or appropriate.
          </p>
          <p>
            The updated Privacy Policy will include a revised &quot;Last
            Updated&quot; date.
          </p>
          <p>
        ...
        <Section num="18" title="Acceptance of This Privacy Policy">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              Your information may be collected or processed as described in
              this Privacy Policy
            </li>
            <li>
            ...
            <li>
              You are responsible for obtaining any required permissions and,
