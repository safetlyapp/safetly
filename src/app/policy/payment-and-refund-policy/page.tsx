      ...
      <div>
        ...
        <div className="mt-8 space-y-8">
          <Section num="1" title="Subscription Plans">
            ...
            <p>
              Certain features may not be available on every subscription plan
              or device. Feature availability may depend on the device type,
              Android or iPhone version, operating system, permissions granted,
              technical limitations, and selected subscription plan.
            </p>
          </Section>
          ...
          <Section num="2" title="Payment Methods">
            ...
            <p>
              The terms, security policies, and privacy policies of the relevant
              payment service provider may also apply when you make a payment.
            </p>
          </Section>
          ...
          >
            ...
            <p>
              Subscriptions may generally be activated shortly after payment
              verification. However, activation may be delayed due to internet
              connectivity, payment gateway processing, mobile financial service
              systems, servers, app-related issues, or other technical reasons.
            </p>
            <p>
          ...
          <Section num="4" title="Pricing and Payment Amount">
            ...
            <p>
              Before making a payment, you are responsible for reviewing the
              displayed price, subscription duration, and included features.
            </p>
            <p>
              Additional charges may apply through payment gateways, mobile
              financial service providers, or other payment services. Any such
              charges may be determined according to the policies of the
            ...
            <p>
              ...
              is required by law, security, or technical necessity.
            </p>
          </Section>

          <Section num="5" title="Subscription Duration">
            <p>
              The duration of your subscription will depend on the plan you
              select.
            </p>
            <p>
              The subscription period may begin when the subscription is
              successfully activated. After the subscription expires, paid
              features may be limited, suspended, or unavailable unless you
          ...
          <Section num="6" title="Automatic Renewal">
            <p>
              If a subscription plan includes automatic renewal, this will be
              clearly disclosed before payment or during the subscription
              process.
            </p>
            <p>
              If automatic renewal is not enabled, you will need to purchase a
              new subscription after your current subscription period ends.
            </p>
          </Section>
          ...
          <Section num="7" title="Payment Security">
            ...
            <p>
              Payment information may be processed according to the security and
              privacy policies of the relevant payment service provider.
            </p>
          </Section>

          <Section num="8" title="Failed or Incomplete Payments">
            <p>
              If a payment fails, is canceled, or remains incomplete, your
            ...
            <p>
              If a transaction remains pending or incomplete in the payment
              provider&apos;s system, the transaction may be completed,
              canceled, reversed, or otherwise adjusted according to the
              policies and procedures of the relevant payment provider.
            </p>
          </Section>
          ...
          <Section num="13" title="Contact Us">
            <p>
              For payment-related questions, concerns, or support, please
              contact:
            </p>
      ...
      <div>
        ...
        <div className="mt-8 space-y-8">
          <Section num="1" title="General Refund Policy">
            ...
            <p>
              Refunds are not automatically guaranteed. Each refund request may
              be reviewed individually based on factors including:
            </p>
            <ul className="list-disc space-y-1 pl-5">
          ...
          <Section num="2" title="Situations Where a Refund May Be Considered">
            <SubSection title="2.1 Duplicate or Excess Payment">
              If you were accidentally charged more than once for the same
              subscription and the additional payment is verified, the excess
          ...
          <Section
            num="3"
            title="Situations Where a Refund May Not Be Available"
          >
            <p>A refund may be denied in situations including:</p>
            <ul className="list-disc space-y-1 pl-5">
              <li>
                The subscription was successfully activated and the service was
                used
              </li>
              ...
              <li>
                A feature did not work because of device incompatibility,
                operating-system restrictions, or technical limitations
              </li>
              <li>
                The service was interrupted because of internet connectivity,
                mobile-network issues, or third-party service problems
              </li>
              <li>
              ...
              <li>
                Your account was suspended or terminated because you violated
              ...
              <li>
                You request a refund for unused subscription time after using
                part of the subscription, unless applicable law provides
                otherwise
              </li>
              <li>
                You request a refund solely because you changed your mind after
                the subscription was activated or used
              </li>
            </ul>
          </Section>
          ...
          <Section num="5" title="How to Request a Refund">
            ...
            <p className="rounded-lg bg-amber-50 px-4 py-3 text-amber-800">
              For your security, never send your bKash, Nagad, or Rocket PIN,
              OTP, or confidential payment password by email.
            </p>
          </Section>
          ...
          <Section num="6" title="Refund Review and Verification">
            ...
            <p>
              Incorrect, incomplete, or misleading information may delay or
              result in the denial of a refund request.
            </p>
          </Section>
          ...
          <Section num="9" title="Partial Refunds">
            ...
            <p>
              A partial refund is not automatic and will be reviewed on a
              case-by-case basis.
            </p>
          </Section>
          ...
          <Section num="10" title="Alternative Solutions">
            ...
            <p>
              Where applicable law gives you a right to a refund, an alternative
              solution will not limit that legal right.
            </p>
          </Section>
          ...
          <Section num="13" title="Contact Us">
            <p>
              For refund-related questions, requests, or complaints, please
              contact:
            </p>
            <p className="font-medium text-slate-800">
              Safetly Authority
