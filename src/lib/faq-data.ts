...
export const FAQ_CATEGORIES: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Features that depend on those permissions may work only partially or may not work at all.',
      },
      {
        q: 'Can I change permissions later?',
        a: "Yes. You can change or revoke permissions through your device's Settings. However, disabling required permissions may affect the availability or functionality of certain features.",
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: 'What is Live Location?',
        a: 'Live Location helps parents view the current or most recently available location of a connected child device.',
      },
      {
        q: 'Is the location always 100% accurate?',
        a: 'No. Location accuracy may depend on GPS, Wi-Fi, mobile networks, environmental conditions, device settings, and internet connectivity.',
      },
      {
        q: 'Why is the location update delayed?',
        a: 'Location updates may be delayed because of a weak internet connection, disabled GPS, battery-saving settings, background restrictions, or device-specific settings.',
      },
      {
        q: 'What is Location History?',
        a: 'Location History may help parents review previous location or movement information associated with a connected device.',
      },
      {
      ...
      },
      {
        ...
        a: 'Check location permissions, GPS settings, internet connectivity, notification permissions, and background activity settings on the relevant device.',
      },
      {
        q: "Can I see a device's location when the phone is turned off?",
        a: 'A device that is turned off may not be able to send new location information. In some cases, the last available location may be displayed.',
      },
      {
    ...
    items: [
      {
        ...
        a: 'Screen Time provides information about how long a connected device is used and may help parents manage device usage based on available settings.',
      },
      {
        q: 'Can I set a daily screen-time limit?',
        a: 'Depending on the current version and available features, you may be able to set daily device-use limits.',
      },
      {
        q: 'What happens when the screen time limit is reached?',
        a: 'Depending on your selected settings, access to certain apps or device functions may be limited.',
      },
      {
        q: 'Can I set different limits for specific apps?',
        a: 'If the feature is available, separate usage limits may be set for selected applications.',
      },
      {
        q: 'What is App Blocking?',
        a: 'App blocking helps parents restrict or block access to selected applications on a connected child device.',
      },
      {
        q: 'Can every app be blocked?',
        a: 'Some system applications, emergency functions, or protected services may not be blocked because of operating-system or device restrictions.',
      },
      {
      ...
      },
      {
        ...
        a: 'Report updates may depend on internet connectivity, device settings, background activity, and technical conditions.',
      },
      {
        q: 'Does Screen Time work the same way on every iPhone?',
        a: 'No. Because of iOS security requirements and system policies, some features may function differently from Android devices.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: 'Content filtering helps limit access to inappropriate, harmful, or unwanted websites and online content.',
      },
      {
        q: 'Can I block specific websites?',
        a: 'If the feature is available, you may be able to block selected websites or domains.',
      },
      {
        q: 'Can I allow specific websites?',
        a: 'Depending on the available features, you may be able to create a list of approved or allowed websites.',
      },
      {
        q: 'Is content filtering 100% accurate?',
        a: 'No. No automated filtering system is completely accurate. Parental guidance and appropriate supervision remain important.',
      },
      {
        q: 'What if a safe website is blocked by mistake?',
        a: 'You may add the website to an allowed list or review and adjust the content-filtering settings.',
      },
      {
        q: 'Does content filtering work in every browser?',
        a: 'Functionality may vary depending on the browser, device, operating system, and applicable platform restrictions.',
      },
      {
        q: 'Can content filtering control all content inside every app?',
        a: 'No. Some app content may not be detected or controlled because of encryption, app-specific security, or platform limitations.',
      },
      {
        q: 'What should I do if content filtering does not work?',
        a: 'Check your internet connection, required permissions, app updates, and filtering settings.',
      },
      {
        q: 'Does content filtering guarantee complete online safety?',
        a: 'No. Content filtering is designed to help reduce risks and support parental supervision. It cannot guarantee complete protection from every online risk.',
      },
      {
        q: 'What should I do if my child encounters inappropriate content?',
        a: 'Speak with your child calmly, review the relevant safety settings, block or restrict the content if appropriate, and provide guidance about safe and responsible internet use.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Surrounding Sound features may provide audio-related information from an authorized connected device for family safety and parental supervision purposes, subject to permissions, compatibility, and applicable laws.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Your subscription is generally activated after payment is successfully completed and verified. Technical or payment-processing delays may occasionally occur.',
      },
      {
      ...
      },
      {
        ...
        a: 'After your subscription expires, paid features may become limited or unavailable. You may need to purchase or renew a subscription to continue using premium services.',
      },
      {
        q: 'Will my subscription renew automatically?',
        a: 'If a plan includes automatic renewal, this will be clearly disclosed before payment or during the subscription process. If automatic renewal is not enabled, you may need to purchase a new subscription manually.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'If a subscription has been activated and used, a refund may not be available. Requests may be reviewed based on the circumstances, the Refund Policy, applicable law, and the extent of service use.',
      },
      {
        q: 'Can I receive a refund if I purchased the wrong plan?',
        a: 'A refund is not guaranteed when the wrong plan is selected. The request may be reviewed based on the circumstances, service usage, and applicable policies.',
      },
      {
